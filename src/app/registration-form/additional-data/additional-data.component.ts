import { Component, createComponent, EventEmitter, Output } from '@angular/core';
...
keyEnterFun()
{
  ...
  if(this.pattern.test(this.innerForm.value.name)) //if entered input is valid, sending data to parent comp
  {
    // console.log("val");
   this.labelValue.emit(this.innerForm.value.name);
   this.error="";
